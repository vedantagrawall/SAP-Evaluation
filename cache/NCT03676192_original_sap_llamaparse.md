...
# 4.6 Missing primary efficacy assessment
...
# Summaries of concomitant medications
...
| Name                                         | Category                                         |
| -------------------------------------------- | ------------------------------------------------ |
| Hypersensitivity/infusion-related reactions  | captured on CRF (recorded as 䤀RR in the 䄀E page) |
| Gastrointestinal perforations and fistulae   | Gastrointestinal perforation                     |
| Wound healing complications                  | se氀ected 䴀edDR䄀 倀Ts                              |
| Hypertension                                 | Hypertension                                     |
| Posterior reversible encephalopathy syndrome | Posterior reversible encephalopathy syndrome     |
| Proteinuria                                  | Proteinuria                                      |
| Arterial thromboembolism                     | Embolic and thrombotic events, arterial          |
| Venous thromboembolism                       | Embolic and thrombotic events, venous            |
| Hemorrhages (Bleeding)                       | Haemorrhage terms (excl laboratory terms)        |
| Congestive heart failure                     | Cardiac failure                                  |
| Ovarian failure/fertility                    | Ovarian failure                                  |
...
ECOG performance status will be assessed at the time points specified in the Appendix 14.1. Results will be classified as either ‘Grade 0’, ‘Grade 1’, ‘Grade 2’, ‘Grade 3’, ‘Grade 4’ or ‘Grade 5’ and the number and percentage of patients within each class will be provided by treatment group and visit. All ECOG status data will be listed for safety population.
...
| Procedure                                                              | Screening¹ (Day -28 to Randomization) | Induction Cycle 1 Day 1 | Each Cycle End of Cycles 2 and 4 | Maintenance Study Period² | EOT³ | Follow-Up Period⁴ |
| ---------------------------------------------------------------------- | ------------------------------------- | ----------------------- | -------------------------------- | ------------------------- | ---- | ----------------- |
| Informed consent                                                       | X                                     |                         |                                  |                           |      |                   |
...
| Hypersensitivity monitoring                                            | X                                     |                         | X                                |                           |      |                   |
...
| Tumor Evaluation¹⁵                       | - CT (chest and abdomen)   | X¹⁶                    |                                   | X                     | X                    | X        |   |
|                                          | - CT or MRI (brain)¹⁷      | X¹⁶                    | (X)                               | (X)                   | (X)                  | (X)      |   |
|                                          | - Bone scan.18             | X¹⁶                    | (X)                               | (X)                   | (X)                  | (X)      |   |
...
| -------------------------- | --------------------------------------------------------------------- | ------------------------------------------ | ------------------------------------------------- | --------------------------------------------- | ---------------------------------------------- |
| Anemia                     | Hemoglobin                                                            | \<LLN - 10.0 g/dL;                         | <10.0 - 8.0 g/dL;                                 | <8.0 g/dL;                                    | -                                              |
|                            | \<LLN - 6.2 mmol/L;                                                   | <6.2 - 4.9 mmol/L;                         | <4.9 mmol/L;                                      | <80 g/L                                       |                                                |
| Alanine aminotransferase   | (ALT)                                                                 | High                                       | >ULN - 3.0 x ULN                                  | >3.0 - 5.0 x ULN if baseline was normal;      | >5.0 - 20.0 x ULN if baseline was normal;      |
|                            | if baseline was normal; 1.5 - 3.0 x baseline if baseline was abnormal | >2.5 - 5.0 x ULN if baseline was abnormal  | >20.0 x ULN if baseline was abnormal              |                                               |                                                |
| Alkaline phosphatase       |                                                                       | High                                       | >ULN - 3.0 x ULN                                  | >3.0 - 5.0 x ULN if baseline was normal;      | >5.0 - 20.0 x ULN if baseline was normal;      |
|                            | if baseline was normal; 2.0 - 2.5 x baseline if baseline was abnormal | >2.5 - 5.0 x ULN if baseline was abnormal  | >20.0 x ULN if baseline was abnormal              |                                               |                                                |
| Aspartate aminotransferase | (AST)                                                                 | High                                       | >ULN - 1.5 x ULN                                  | >1.5 - 3.0 x ULN if baseline was normal;      | >3.0 - 10.0 x ULN if baseline was normal;      |
|                            | if baseline was normal; 1.5 - 3.0 x baseline if baseline was abnormal | >3.0 - 10.0 x ULN if baseline was abnormal | >10.0 x ULN if baseline was abnormal              |                                               |                                                |
| Blood bilirubin            | Total Bilirubin                                                       | High                                       | > 1.0 - 1.5 x baseline if baseline was abnormal   | >1.5 - 3.0 x baseline if baseline was normal; | >3.0 - 10.0 x baseline if baseline was normal; |
|                            |                                                                       |                                            | normal; >10.0 x baseline if baseline was abnormal |                                               |                                                |
...
| Hypoalbuminemia Albumin                    | Low                                                                        | <3 - 2 g/dL; <30 - 20 g/L                                                                    | <2 g/dL; <20 g/L                                                                               | -                                         |
...
CTCAE Term|                            |                           |                     |                                              |                                              |                                         |                           |
| -------------------------- | ------------------------- | ------------------- | -------------------------------------------- | -------------------------------------------- | --------------------------------------- | ------------------------- |
| Laboratory Parameter       | Level                     | Grade 1             | Grade 2                                      | Grade 3                                      | Grade 4                                 |                           |
...
| Neutrophil count decreased | Absolute neutrophil count | Low                 | \<LLN - 1500/mm³;                            | <1500 - 1000/mm³; <1.5 - 1.0 x 10e⁹ /L       | <1000 - 500/mm³; <1.0 - 0.5 x 10e⁹ /L   | <500/mm³; <0.5 x 10e⁹ /L  |
| Platelet count             | Low                       | \<LLN - 75,000/mm³; | <75,000 - 50,000/mm³; <75.0 - 50.0 x 10e⁹ /L | <50,000 - 25,000/mm³; <50.0 - 25.0 x 10e⁹ /L | <25,000/mm³; <25.0 x 10e⁹ /L            |                           |
...
| Laboratory Parameter |                           |                                     | Grade 1                              | Grade 2                               | Grade 3                   | Grade 4 |
| -------------------- | ------------------------- | ----------------------------------- | ------------------------------------ | ------------------------------------- | ------------------------- | ------- |
| Proteinuria¹         |                           | High                                | 1+ proteinuria                       | 2+ and 3+                             | 4+ proteinuria            |         |
| -                    |                           |                                     |                                      |                                       |                           |         |
| Proteinuria¹         | 24 hours urine collection | High                                | ≥ ULN - <1.0 g/24 hrs                | 1.0 - <3.5 g/24 hrs                   | ≥ 3.5 g/24 hrs            |         |
| -                    |                           |                                     |                                      |                                       |                           |         |
| Hypertriglyceridemia | High                      | 150 - 300 mg/dL; 1.71 - 3.42 mmol/L | >300 - 500 mg/dL; >3.42 - 5.7 mmol/L | >500 - 1000 mg/dL; >5.7 - 11.4 mmol/L | >1000 mg/dL; >11.4 mmol/L |         |
